    ...
    <Layout style={{ minHeight: '100vh' }}>
      <Sider collapsible collapsed={collapsed} onCollapse={(value) => setCollapsed(value)}>
        ...
        <Menu theme="dark" defaultSelectedKeys={currentRoute} mode="inline" selectedKeys={currentRoute}>
          ...
          <Menu.SubMenu key={'sub1'} icon={<MenuOutlined />} title={'Маршрутизация'}>
            ...
            <Menu.Item key="cities/list" icon={<EnvironmentOutlined />}>
              <InertiaLink href={route('cities.list')}>Города</InertiaLink>
            </Menu.Item>
          </Menu.SubMenu>
          ...
          <Menu.SubMenu key={'sub4'} icon={<AreaChartOutlined />} title={'Отчеты'}>
            <Menu.Item key="bookings/statistics">
              <InertiaLink href={route('bookings.statistics')}>По броням</InertiaLink>
            </Menu.Item>
          </Menu.SubMenu>
        </Menu>
      </Sider>
